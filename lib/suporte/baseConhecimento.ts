...
export const BASE_CONHECIMENTO: EntradaConhecimento[] = [
  // ───────────────────────── CLIENTES ─────────────────────────
  {
    slug: 'clientes-lista', modulo: 'Clientes', titulo: 'Lista de Clientes', caminho: 'Clientes → Clientes',
  ...
  {
    slug: 'clientes-cadastrar', modulo: 'Clientes', titulo: 'Cadastrar/editar cliente', caminho: 'Clientes → Clientes → "Novo cliente"',
  ...
  {
    slug: 'clientes-massa', modulo: 'Clientes', titulo: 'Ações em massa (ativar/inativar/excluir)', caminho: 'Clientes → Clientes → caixinhas de seleção',
  ...
  {
    slug: 'clientes-importar', modulo: 'Clientes', titulo: 'Importar clientes de planilha', caminho: 'Clientes → Clientes → "Importar planilha"',
  ...
  {
    slug: 'clientes-ficha', modulo: 'Clientes', titulo: 'Ficha do cliente (dados, contatos, endereços)', caminho: 'Clientes → Clientes → clicar no cliente',
  ...
  {
    slug: 'clientes-historico', modulo: 'Clientes', titulo: 'Histórico e resumo do cliente', caminho: 'Clientes → cliente → abas Histórico e Resumo',
  ...
  {
    slug: 'clientes-visao-geral', modulo: 'Clientes', titulo: 'Visão Geral (relatório de clientes)', caminho: 'Clientes → Visão Geral',
  ...
  {
    slug: 'clientes-ativar', modulo: 'Clientes', titulo: 'Liberar o módulo Clientes', caminho: 'Config → Geral (módulos)',
  ...
  // ───────────────────────── LOJA VIRTUAL ─────────────────────────
  {
    slug: 'loja-ativar', modulo: 'Loja', titulo: 'Ativar a Loja Virtual', caminho: 'Config → Geral → Módulos',
  ...
  {
    slug: 'loja-configurar', modulo: 'Loja', titulo: 'Configurar a Loja (link, logo, frete, catálogo)', caminho: 'Config → Loja Virtual',
  ...
  {
    slug: 'loja-link', modulo: 'Loja', titulo: 'Link público da loja', caminho: 'Config → Loja Virtual → Link da loja',
  ...
  {
    slug: 'loja-banner', modulo: 'Loja', titulo: 'Banner/capa da loja', caminho: 'Config → Loja Virtual → Banner/capa',
  ...
  {
    slug: 'loja-colecoes', modulo: 'Loja', titulo: 'Coleções da vitrine', caminho: 'Config → Loja Virtual → Gerenciar vitrine → Coleções',
  ...
  {
    slug: 'loja-produtos-vitrine', modulo: 'Loja', titulo: 'Produtos na vitrine (ordem, destaque)', caminho: 'Config → Loja Virtual → Gerenciar vitrine → Produtos',
  ...
  {
    slug: 'loja-visibilidade-variacao', modulo: 'Loja', titulo: 'Visibilidade por configuração (variação)', caminho: 'Config → Loja Virtual → Gerenciar vitrine → produto → Fotos e configurações',
  ...
  {
    slug: 'loja-galeria', modulo: 'Loja', titulo: 'Galeria de fotos (produto e variação)', caminho: 'Config → Loja Virtual → Gerenciar vitrine → produto → Galeria',
  ...
  {
    slug: 'loja-atributos', modulo: 'Loja', titulo: 'Opções de compra / atributos (Tamanho, Quantidade)', caminho: 'Config → Loja Virtual → Gerenciar vitrine → produto → Opções de compra',
  ...
  {
    slug: 'loja-pagamento', modulo: 'Loja', titulo: 'Formas de pagamento (PIX, Link, Mercado Pago)', caminho: 'Config → Loja Virtual → Formas de pagamento',
  ...
  {
    slug: 'loja-publica', modulo: 'Loja', titulo: 'Loja pública (como a cliente compra)', caminho: 'seudominio/loja/seu-link',
  ...
  {
    slug: 'loja-pedidos', modulo: 'Loja', titulo: 'Pedidos da Loja', caminho: 'Minha Loja → Pedidos da Loja',
  ...
  {
    slug: 'loja-visao-geral', modulo: 'Loja', titulo: 'Visão Geral da Minha Loja', caminho: 'Minha Loja',
  ...
  // ───────────────────────── TAREFAS ─────────────────────────
  {
    slug: 'tarefas-ativar', modulo: 'Tarefas', titulo: 'Ativar o módulo de Tarefas', caminho: 'Config → Geral',
  ...
  {
    slug: 'tarefas-visao-geral', modulo: 'Tarefas', titulo: 'Visão Geral (painel)', caminho: 'Tarefas → Visão Geral',
  ...
  {
    slug: 'tarefas-quadros', modulo: 'Tarefas', titulo: 'Criar e gerenciar Quadros', caminho: 'Tarefas → Quadros',
  ...
  {
    slug: 'tarefas-colunas', modulo: 'Tarefas', titulo: 'Colunas do quadro', caminho: 'Tarefas → Quadros → abrir quadro',
  ...
  {
    slug: 'tarefas-cards', modulo: 'Tarefas', titulo: 'Criar tarefas e arrastar cards (Kanban)', caminho: 'Tarefas → Quadros → abrir quadro',
  ...
  {
    slug: 'tarefas-detalhes', modulo: 'Tarefas', titulo: 'Detalhes do card', caminho: 'Tarefas → Quadros → abrir card',
  ...
  {
    slug: 'tarefas-etiquetas', modulo: 'Tarefas', titulo: 'Etiquetas do card', caminho: 'Tarefas → card → Etiquetas',
  ...
  {
    slug: 'tarefas-checklist', modulo: 'Tarefas', titulo: 'Checklist do card', caminho: 'Tarefas → card → Checklists',
  ...
  {
    slug: 'tarefas-anexos', modulo: 'Tarefas', titulo: 'Anexos / artes no card', caminho: 'Tarefas → card → Artes/imagens',
  ...
  {
    slug: 'tarefas-comentarios', modulo: 'Tarefas', titulo: 'Comentários e menção @', caminho: 'Tarefas → card → Comentários',
  ...
  {
    slug: 'tarefas-vinculos', modulo: 'Tarefas', titulo: 'Vincular tarefa a pedido/pagamento', caminho: 'Tarefas → card → Vínculos',
  ...
  {
    slug: 'tarefas-minhas', modulo: 'Tarefas', titulo: 'Minhas Tarefas', caminho: 'Tarefas → Minhas Tarefas',
  ...
  {
    slug: 'tarefas-calendario', modulo: 'Tarefas', titulo: 'Calendário de Tarefas', caminho: 'Tarefas → Calendário',
  ...
  {
    slug: 'tarefas-atividades', modulo: 'Tarefas', titulo: 'Atividades (histórico)', caminho: 'Tarefas → Atividades',
  ...
  {
    slug: 'assistente-ativar', modulo: 'Assistente de Compras', titulo: 'Ativar o Assistente de Compras', caminho: 'Config → Geral → Módulos → Assistente de Compras',
  ...
  {
    slug: 'assistente-pesquisar', modulo: 'Assistente de Compras', titulo: 'Pesquisar preço de mercado', caminho: 'Assistente de Compras → Pesquisar preço',
  ...
  {
    slug: 'assistente-privacidade', modulo: 'Assistente de Compras', titulo: 'Dados anônimos / dados insuficientes', caminho: 'Assistente de Compras → Pesquisar preço',
  ...
  {
    slug: 'assistente-meus-precos', modulo: 'Assistente de Compras', titulo: 'Meus preços vs mercado', caminho: 'Assistente de Compras → Pesquisar preço → Ver meus preços vs mercado',
  ...
  {
    slug: 'assistente-seguir', modulo: 'Assistente de Compras', titulo: 'Seguir material (alerta no sino)', caminho: 'Assistente de Compras → Pesquisar preço → Seguir preço',
  ...
  {
    slug: 'assistente-evolucao', modulo: 'Assistente de Compras', titulo: 'Histórico e evolução (30 dias)', caminho: 'Assistente de Compras → Pesquisar preço',
  ...
  {
    slug: 'assistente-onde-comprar', modulo: 'Assistente de Compras', titulo: 'Onde comprar (fornecedores/lojas)', caminho: 'Assistente de Compras → Pesquisar preço → Onde comprar',
  ...
  // ───────────────────────── IMPORTAÇÃO ─────────────────────────
  {
    slug: 'import-planilha', modulo: 'Importação', titulo: 'Importar planilha de pedidos', caminho: 'Produção → Pedidos → Importar planilha',
  ...
  {
    slug: 'import-deteccao', modulo: 'Importação', titulo: 'Detecção automática Shopee x Template VPS', caminho: 'Produção → Pedidos → Importar planilha',
  ...
  {
    slug: 'import-preview', modulo: 'Importação', titulo: 'Preview antes de importar (sempre manual)', caminho: 'Produção → Pedidos → Importar planilha → Preview',
  ...
  {
    slug: 'import-existentes', modulo: 'Importação', titulo: 'Pedidos que já existem (pular/adicionar/substituir)', caminho: 'Produção → Pedidos → Importar planilha → Preview',
  ...
  {
    slug: 'import-multiplos', modulo: 'Importação', titulo: 'Vários produtos no mesmo pedido (agrupar/separar)', caminho: 'Produção → Pedidos → Importar planilha → Preview',
  ...
  {
    slug: 'import-pecas-kit', modulo: 'Importação', titulo: 'Quantidade de peças por kit', caminho: 'Produção → Pedidos → Importar planilha → Preview',
  ...
  {
    slug: 'import-vinculo-assistido', modulo: 'Importação', titulo: 'Vínculo assistido de produto + de-para', caminho: 'Produção → Pedidos → Importar planilha → Preview',
  ...
  {
    slug: 'import-criar-copia', modulo: 'Importação', titulo: 'Criar produto por cópia', caminho: 'Produção → Pedidos → Importar planilha → Preview',
  ...
  {
    slug: 'import-cliente', modulo: 'Importação', titulo: 'Vincular comprador a cliente', caminho: 'Produção → Pedidos → Importar planilha → Preview',
  ...
  {
    slug: 'import-auditoria', modulo: 'Importação', titulo: 'Relatório de auditoria (Shopee)', caminho: 'Produção → Pedidos → Importar planilha → Preview',
  ...
  {
    slug: 'mkt-ativar', modulo: 'Financeiro', titulo: 'Ativar "Números do Marketplace"', caminho: 'Financeiro → Números do Marketplace',
  ...
  {
    slug: 'mkt-taxas', modulo: 'Financeiro', titulo: 'Taxas e líquido estimado', caminho: 'Financeiro → Números do Marketplace',
  ...
  {
    slug: 'mkt-previsao', modulo: 'Financeiro', titulo: 'Previsão de recebimento + baixa em lote', caminho: 'Financeiro → Números do Marketplace',
  ...
  {
    slug: 'mkt-margem', modulo: 'Financeiro', titulo: 'Margem real por pedido', caminho: 'Financeiro → Números do Marketplace',
  ...
  {
    slug: 'orcamento-desconto-frete', modulo: 'Orçamentos', titulo: 'Desconto por produto e frete no orçamento', caminho: 'Produção → Orçamentos → Novo/editar orçamento',
  ...
  {
    slug: 'orcamento-basico', modulo: 'Orçamentos', titulo: 'Criar orçamento e link de aprovação', caminho: 'Produção → Orçamentos',
  ...
  {
    slug: 'prec-tecido-m2', modulo: 'Precificação', titulo: 'Tecido por metro → preço por m²', caminho: 'Precificação → Materiais (unidade m²)',
  ...
  {
    slug: 'prec-mao-obra', modulo: 'Precificação', titulo: 'Mão de obra na precificação', caminho: 'Precificação → Produtos → variação → Mão de Obra',
  ...
  {
    slug: 'painel-resultado-vendas', modulo: 'Precificação', titulo: 'Resultado das vendas (painel)', caminho: 'Visão Geral (painel inicial)',
  ...
  {
    slug: 'vincular-pedidos-lote', modulo: 'Precificação', titulo: 'Vincular pedidos à Precificação em lote', caminho: 'Precificação → Produtos → Vincular pedidos à Precificação',
  ...
  // ───────────────────────── PRODUÇÃO (core) ─────────────────────────
  {
    slug: 'producao-criar-pedido', modulo: 'Produção', titulo: 'Criar um pedido', caminho: 'Produção → Pedidos → "+ Novo pedido"',
  ...
  {
    slug: 'producao-workflow-setores', modulo: 'Produção', titulo: 'Workflow de produção (Iniciar/Concluir/Devolver)', caminho: 'Produção → setores (cards do pedido)',
  ...
  {
    slug: 'producao-mover-setor', modulo: 'Produção', titulo: 'Mover pedido entre setores (pedido preso)', caminho: 'Produção → abrir pedido → Fluxo de Produção → "Mover para outro setor"',
  ...
  {
    slug: 'producao-cancelar-excluir', modulo: 'Produção', titulo: 'Cancelar ou excluir um pedido', caminho: 'Produção → Pedidos',
  ...
  {
    slug: 'producao-painel-geral', modulo: 'Produção', titulo: 'Painel Geral e Calendário', caminho: 'Produção → Painel Geral / Calendário',
  ...
  {
    slug: 'config-setores', modulo: 'Config', titulo: 'Setores de produção (criar/editar/excluir)', caminho: 'Config → Produção',
  ...
  {
    slug: 'config-campos-pedido', modulo: 'Config', titulo: 'Campos personalizados do pedido', caminho: 'Config → Campos do Pedido',
  ...
  {
    slug: 'financeiro-lancamentos', modulo: 'Financeiro', titulo: 'Lançamentos (receitas e despesas)', caminho: 'Financeiro → Lançamentos',
  ...
  {
    slug: 'estoque-materiais-produtos', modulo: 'Estoque', titulo: 'Estoque de materiais e de produtos (ativar)', caminho: 'Config → Geral → Módulos → Estoque de Produtos',
  ...
  {
    slug: 'config-geral', modulo: 'Config', titulo: 'Configurações gerais (ateliê, tema, módulos)', caminho: 'Config → Geral',
  ...
  {
    slug: 'suporte-central', modulo: 'Suporte', titulo: 'Central de Suporte (chamado, FAQ, feedback)', caminho: 'Menu → Suporte',
