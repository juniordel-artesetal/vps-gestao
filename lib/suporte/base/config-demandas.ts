...
export const ENTRADAS: EntradaConhecimento[] = [
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    faq: [
      ...
      { pergunta: 'Não consigo acessar / estou bloqueada. Como falo com o suporte?', resposta: 'Fica tranquila, dá pra pedir ajuda MESMO sem conseguir entrar. Na tela de login e na tela de "reativar acesso/período de teste", tem um botão "Está com problema pra acessar? Fale com a gente". Clique nele, preencha seu nome, e-mail, WhatsApp e conte o que houve (ex.: "paguei mas não consigo entrar") e envie. Você recebe um número de protocolo na hora, e a equipe é avisada na mesma hora — a gente te retorna pelo seu e-mail ou WhatsApp o quanto antes. Você não precisa achar o WhatsApp de ninguém nem estar logada: o pedido de socorro sai de dentro da própria tela de login.' },
    ],
  },
