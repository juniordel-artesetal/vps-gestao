  ...
  return (
    <div className="max-w-3xl mx-auto p-4 sm:p-6 space-y-4">
      ...
      <div className="rounded-2xl border border-dashed border-gray-300 dark:border-gray-700 p-8 text-center space-y-2">
        ...
        <h1 className="text-lg font-semibold text-gray-900 dark:text-white">Edição em massa de artes</h1>
        <p className="text-sm text-gray-500">O editor de campos e a geração em lote estão sendo montados. Em breve: subir o molde, marcar os campos e gerar tudo de uma vez.</p>
      </div>
    </div>
  )
}
