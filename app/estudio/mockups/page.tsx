...
export default function Mockups() {
  return (
    <div className="max-w-7xl mx-auto p-4 sm:p-6 space-y-4">
      <Link href="/estudio/caixas" className="text-sm text-gray-500 hover:text-orange-600 inline-flex items-center gap-1"><ArrowLeft className="w-4 h-4" /> Kit de produtos</Link>
      <div>
