  ...
  try {
    const res = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        ...
        to: [feedback.email],
        subject: `Re: [${feedback.protocolo || 'Feedback'}] Resposta da Equipe VPS Gestão`,
        html: `
          <div style="font-family:sans-serif;max-width:600px;margin:0 auto">
            <div style="background:#f97316;padding:20px 24px;border-radius:12px 12px 0 0">
              <h2 style="color:#fff;margin:0;font-size:18px">Resposta da Equipe VPS Gestão</h2>
            </div>
            <div style="background:#fff;padding:24px;border:1px solid #eee;border-top:none;border-radius:0 0 12px 12px">
              ...
              <p style="color:#999;font-size:12px;margin-top:16px">
                Obrigado por nos ajudar a melhorar o VPS Gestão!<br/>
                Acesse a <a href="https://app.vps-gestao.com.br/suporte" style="color:#f97316">Central de Suporte</a> a qualquer momento.
              </p>
            </div>
          </div>
        `,
