...
const modulos: Modulo[] = [
  ...
  { href:'/compras',      label:'Compras',        descricao:'Fornecedores, pesquisa de preço, pedido de compra e histórico.', icon:ShoppingCart, cor:'bg-teal-50 text-teal-600 dark:bg-teal-900/20 dark:text-teal-400', roles:['ADMIN'] },
