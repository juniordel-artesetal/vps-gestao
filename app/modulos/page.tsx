...
const modulos: Modulo[] = [
  ...
  { href:'/config/loja', label:'Loja Virtual',   descricao:'Sua vitrine online, do seu jeito.',      icon:Store,      cor:'bg-indigo-50 text-indigo-600 dark:bg-indigo-900/20 dark:text-indigo-400', roles:['ADMIN'] },
