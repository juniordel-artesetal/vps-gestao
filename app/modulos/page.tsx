...
const modulos: Modulo[] = [
  ...
  { href:'/minha-loja',   label:'Minha Loja',     descricao:'Sua loja online: vendas, vitrine e pagamentos.', icon:Store,  cor:'bg-indigo-50 text-indigo-600 dark:bg-indigo-900/20 dark:text-indigo-400', roles:['ADMIN'] },
  { href:'/pesquisa-preco', label:'Pesquisa de preço (IA)', descricao:'Faixa de preço de mercado dos materiais.', icon:Sparkles, cor:'bg-amber-50 text-amber-600 dark:bg-amber-900/20 dark:text-amber-400', roles:['ADMIN'] },
  { href:'/tarefas',      label:'Tarefas',        descricao:'Organize, acompanhe e entregue.',        icon:ListChecks, cor:'bg-sky-50 text-sky-600 dark:bg-sky-900/20 dark:text-sky-400',             roles:['ADMIN','DELEGADOR'] },
