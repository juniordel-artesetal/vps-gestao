...
import { ArrowLeft, Plus, X, Trash2, Paperclip, MessageSquare, Search, Calendar, User as UserIcon, Upload, Clock } from 'lucide-react'
...
export default function KanbanPage() {
  ...
  async function carregar() {
    ...
    if (d.error) { router.push('/tarefas'); return }
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-50 dark:bg-gray-900">
      ...
      <div className="px-4 py-3 border-b border-gray-100 dark:border-gray-800 flex items-center gap-3 flex-wrap">
        <button onClick={() => router.push('/tarefas')} className="text-gray-400 hover:text-gray-600"><ArrowLeft size={18} /></button>
