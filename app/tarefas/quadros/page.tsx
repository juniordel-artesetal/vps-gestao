...
export default function QuadrosHub() {
      ...
      <div className="max-w-4xl mx-auto p-6">
        <div className="flex items-center justify-between mb-5">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-semibold text-gray-900 dark:text-white">Quadros</h1>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            {quadros.map(q => (
              <div key={q.id} className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 overflow-hidden group">
                <button onClick={() => router.push(`/tarefas/quadros/${q.id}`)} className="w-full text-left">
